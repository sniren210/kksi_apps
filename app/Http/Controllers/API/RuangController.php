...
class RuangController extends BaseController
{
    public function index()
    {
        ...
        return $this->sendResponse(RuangResource::collection($data),'Ruang berhasil diambil');
    }
    ...
    public function store(Request $request)
    {
        ...
        return $this->sendResponse(new RuangResource($create), 'Produk Berhasil di buat');
    }
    ...
    public function show($id)
    {
        ...
        return $this->sendResponse(new RuangResource($data), 'Produk berhasil diambil');
    }
    ...
    public function update(Request $request, Ruang $product)
    {
        ...
        return $this->sendResponse(new RuangResource($product), 'Produk Berhasil di Update');
    }
