...
class AjuanController extends BaseController
{
    public function index()
    {
        ...
        return $this->sendResponse(AjuanResource::collection($data),'Ajuan berhasil diambil');
    }
    ...
    public function store(Request $request)
    {
        ...
        return $this->sendResponse(new AjuanResource($create), 'Produk Berhasil di buat');
    }
    ...
    public function show($id)
    {
        ...
        return $this->sendResponse(new AjuanResource($data), 'Produk berhasil diambil');
    }
    ...
    public function update(Request $request, Ajuan $product)
    {
        ...
        return $this->sendResponse(new AjuanResource($product), 'Produk Berhasil di Update');
    }
