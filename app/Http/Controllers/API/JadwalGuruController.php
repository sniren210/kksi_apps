...
class JadwalGuruController extends BaseController
{
    public function index()                                                                  
    {
        ...
        return $this->sendResponse(JadwalGuruResource::collection($data),'Jadwal_guru berhasil diambil');
    }
    ...
    public function show($id)
    {
        ...
        return $this->sendResponse(new JadwalGuruResource($data), 'Produk berhasil diambil');
    }
    ...
    public function update(Request $request,Jadwal_guru $product)
    {
        ...
        return $this->sendResponse(new JadwalGuruResource($product), 'Produk Berhasil di Update');
    }
