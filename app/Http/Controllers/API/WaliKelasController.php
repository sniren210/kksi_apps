...
class WaliKelasController extends BaseController
{
    public function index()
    {
        ...
        return $this->sendResponse(WaliKelasResource::collection($data),'wali_kelas berhasil diambil');
    }
    ...
    public function store(Request $request)
    {
        ...
        return $this->sendResponse(new WaliKelasResource($create), 'Produk Berhasil di buat');
    }
    ...
    public function show($id)
    {
        ...
        return $this->sendResponse(new WaliKelasResource($data), 'Produk berhasil diambil');
    }
    ...
    public function update(Request $request, wali_kelas $product)
    {
        ...
        return $this->sendResponse(new WaliKelasResource($product), 'Produk Berhasil di Update');
    }
