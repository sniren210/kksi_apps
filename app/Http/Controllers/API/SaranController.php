...
class SaranController extends BaseController
{
    public function index()
    {
        ...
        return $this->sendResponse(SaranResource::collection($data),'Saran berhasil diambil');
    }
    ...
    public function store(Request $request)
    {
        ...
        return $this->sendResponse(new SaranResource($create), 'Produk Berhasil di buat');
    }
    ...
    public function show($id)
    {
        ...
        return $this->sendResponse(new SaranResource($data), 'Produk berhasil diambil');
    }
    ...
    public function update(Request $request, Saran $product)
    {
        ...
        return $this->sendResponse(new SaranResource($product), 'Produk Berhasil di Update');
    }
