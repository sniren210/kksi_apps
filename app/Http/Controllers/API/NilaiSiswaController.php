...
class NilaiSiswaController extends BaseController
{
    public function index()
    {
        ...
        return $this->sendResponse(NilaiSiswaResource::collection($data),'Nilai_siswa berhasil diambil');
    }
    ...
    public function store(Request $request)
    {
        ...
        return $this->sendResponse(new NilaiSiswaResource($create), 'Produk Berhasil di buat');
    }
    ...
    public function show($id)
    {
        ...
        return $this->sendResponse(new NilaiSiswaResource($data), 'Produk berhasil diambil');
    }
    ...
    public function update(Request $request, Nilai_siswa $product)
    {
        ...
        return $this->sendResponse(new NilaiSiswaResource($product), 'Produk Berhasil di Update');
    }
