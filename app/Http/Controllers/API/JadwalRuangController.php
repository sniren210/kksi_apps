...
class JadwalRuangController extends BaseController
{
    public function index()
    {
        ...
        return $this->sendResponse(JadwalRuangResource::collection($data),'jadwal ruang berhasil diambil');
    }
    ...
    public function store(Request $request)
    {
        ...
        return $this->sendResponse(new JadwalRuangResource($create), 'Produk Berhasil di buat');
    }
    ...
    public function show($id)
    {
        ...
        return $this->sendResponse(new JadwalRuangResource($data), 'Produk berhasil diambil');
    }
    ...
    public function update(Request $request, jadwal_ruang $product)
    {
        ...
        return $this->sendResponse(new JadwalRuangResource($product), 'Produk Berhasil di Update');
    }
