...
class Kategori_postController extends BaseController
{
    public function index()
    {
        ...
        return $this->sendResponse(Kategori_postResource::collection($data),'Kategori_post berhasil diambil');
    }
    ...
    public function store(Request $request)
    {
        ...
        return $this->sendResponse(new Kategori_postResource($create), 'Produk Berhasil di buat');
    }
    ...
    public function show($id)
    {
        ...
        return $this->sendResponse(new Kategori_postResource($data), 'Produk berhasil diambil');
    }
    ...
    public function update(Request $request, Kategori_post $product)
    {
        ...
        return $this->sendResponse(new Kategori_postResource($product), 'Produk Berhasil di Update');
    }
