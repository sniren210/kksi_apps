...
class GuruController extends BaseController
{
    public function index()
    {
        ...
        return $this->sendResponse(GuruResource::collection($data),'Guru berhasil diambil');
    }
    ...
    public function show($id)
    {
        ...
        return $this->sendResponse(new GuruResource($data), 'Produk berhasil diambil');
    }
    ...
    public function update(Request $request, Guru $product)
    {
        ...
        return $this->sendResponse(new GuruResource($product), 'Produk Berhasil di Update');
    }
