...
class JadwalKelasController extends BaseController
{
    public function index()
    {
        ...
        return $this->sendResponse(JadwalKelasResource::collection($data),'jadwal_kelas berhasil diambil');
    }
    ...
    public function show($id)
    {
        ...
        return $this->sendResponse(new JadwalKelasResource($data), 'Produk berhasil diambil');
    }
    ...
    public function update(Request $request, jadwal_kelas $product)
    {
        ...
        return $this->sendResponse(new JadwalKelasResource($product), 'Produk Berhasil di Update');
    }
